...
public class NoteArm extends SubsystemBase {
    ...
    private final Mechanism2d note_arm_mechanism = new Mechanism2d(100, 100);
    // private final MechanismLigament2d rootJoint = new MechanismLigament2d("rootJoint", 10, 0);
    // private final MechanismLigament2d hingeJoint = new MechanismLigament2d("hingeJoint", 10, 30);
    ...
    public NoteArm(){
        ...
        SmartDashboard.putData("NoteArmMechanism", note_arm_mechanism);
    }

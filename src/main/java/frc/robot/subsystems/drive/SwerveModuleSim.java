...
public class SwerveModuleSim implements SwerveModuleIO {
    private FlywheelSim drive_sim = new FlywheelSim(DCMotor.getNEO(1), 6.75, 0.025);
    private FlywheelSim turn_sim = new FlywheelSim(DCMotor.getNEO(1), 150.0 / 7.0, 0.004);
